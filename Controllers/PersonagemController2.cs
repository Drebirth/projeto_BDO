...
{
    [Authorize]
    public class PersonagemController2: Controller
    {
        private readonly BdoContext _bdoContext;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public PersonagemController2(BdoContext bdoContext, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public IActionResult Index()
        {
            ...
            var personagens = _bdoContext.Personagens.ToList( ).Where(x => x.NomeDeFamilia == logado);
        ...
        public IActionResult Create(Personagem personagem)
        {
          ...
          if(ModelState.IsValid)
            {
                personagem.NomeDeFamilia = usuario;
